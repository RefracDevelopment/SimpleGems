...
public class SQLManager {
    ...
    private final int port = ConfigurationManager.Setting.MYSQL_PORT.getInt();
    ...
    public SQLManager() {
        ...
        Bukkit.getScheduler().runTaskAsynchronously(SimpleGems.getInstance(), this::createTables);
    }
